> **This is not the production engine.** MACE-MP-0 medium is kept as a comparison baseline. The engine this project recommends is MACE-MPA-0 medium, whose report is `reports/validation_report.md`; engines are compared on identical structures in `reports/phase3/screening.md`. Numbers below describe this engine only.
...
* **Threshold:** call a new material stable when its predicted energy above hull is ≤ -30 meV/atom (cost-optimal on the calibration set at the placeholder costs). At that threshold **at least 64% of 'stable' calls are right** (point 69%) and at least 49% of truly stable materials are found (point 53%); 'unstable' calls are right at least 91.0% of the time. Precision verdict: use with caution.
* **Energy error on new materials, upper bound by true hull distance:** <0: ≤ 46 meV/atom (use with caution); 0–0.025: ≤ 30 meV/atom (use with caution); 0.025–0.1: ≤ 45 meV/atom (use with caution); 0.1–0.3: ≤ 69 meV/atom (not trustworthy); >0.3: ≤ 136 meV/atom (not trustworthy).
* **Relaxation changes the structure** for 7% (<0), 5% (0–0.025), 7% (0.025–0.1), 12% (0.1–0.3), 18% (>0.3) of new materials; those results carry 2.3× the energy error of the rest (118 vs 52 meV/atom MAE) and should go to DFT, not to the lab.
...
* WBM calibration: 3,993 usable relaxations, 7 rejected by the convergence / sanity guard (counted, not scored), 0 without a result yet.
...
|:----------|:-----------------------------------|----:|----------------------------:|:---------------------|:----------------------|:----------------------|:------------------------|:---------------------|:--------------------|:-------------------------------|
| ≤0.025    | relaxed into a different structure |  10 |                           0 | 20.3 [7.6, 36.9]     | 13.6 [2.1, 26.9]      | 14.3 [5.3, 35.1]      | -16.6 [-34.3, -1.6]     | 6.37 [1.91, 12.30]   | 3.43 [0.10, 12.41]  | use with caution               |
| ≤0.025    | same structure                     | 490 |                           0 | 12.7 [10.9, 15.2]    | 7.3 [6.4, 8.0]        | 9.2 [8.4, 10.1]       | +5.6 [+3.6, +8.3]       | 1.08 [0.79, 1.50]    | 0.43 [0.37, 0.49]   | trustworthy                    |
| 0.025–0.1 | relaxed into a different structure |  39 |                           0 | 23.9 [19.4, 28.4]    | 22.2 [18.5, 26.9]     | 23.1 [18.2, 28.1]     | -21.6 [-27.0, -15.9]    | 8.97 [5.31, 12.91]   | 2.80 [1.37, 7.58]   | trustworthy                    |
| 0.025–0.1 | same structure                     | 461 |                           0 | 15.2 [13.7, 16.7]    | 10.0 [8.8, 11.2]      | 11.9 [10.8, 13.0]     | -3.3 [-5.3, -1.3]       | 1.13 [0.96, 1.32]    | 0.56 [0.49, 0.63]   | trustworthy                    |
| 0.1–0.3   | relaxed into a different structure |  75 |                           0 | 68.7 [56.3, 83.1]    | 53.5 [41.8, 73.3]     | 60.6 [48.8, 74.9]     | -63.4 [-79.6, -50.0]    | 10.29 [4.62, 20.02]  | 3.22 [2.15, 5.32]   | not trustworthy                |
| 0.1–0.3   | same structure                     | 425 |                           0 | 23.9 [21.0, 26.8]    | 12.1 [10.5, 14.5]     | 17.2 [15.1, 19.6]     | -13.0 [-16.5, -9.5]     | 1.86 [1.59, 2.13]    | 0.86 [0.71, 1.06]   | trustworthy                    |
| >0.3      | relaxed into a different structure | 135 |                           2 | 535.2 [401.5, 682.2] | 201.7 [164.5, 295.9]  | 315.7 [242.0, 442.3]  | -532.5 [-680.2, -398.5] | 22.55 [15.83, 31.36] | 12.10 [7.92, 14.71] | not trustworthy                |
| >0.3      | same structure                     | 315 |                           2 | 119.6 [96.3, 142.6]  | 38.9 [30.3, 46.4]     | 70.0 [53.8, 89.3]     | -105.1 [-129.0, -80.9]  | 4.23 [3.40, 5.19]    | 1.31 [1.10, 1.71]   | not trustworthy                |
...
|:----------|:-----------------------------------|----:|----------------------------:|:---------------------|:----------------------|:----------------------|:------------------------|:---------------------|:--------------------|:-------------------------------|
| ≤0.025    | relaxed into a different structure |  12 |                           0 | 35.4 [8.8, 74.1]     | 13.6 [2.2, 30.8]      | 20.4 [6.2, 66.8]      | +4.4 [-28.0, +49.2]     | 6.47 [2.53, 11.49]   | 3.41 [0.10, 12.37]  | not trustworthy                |
| ≤0.025    | same structure                     | 488 |                           0 | 12.7 [11.0, 15.1]    | 7.3 [6.5, 8.0]        | 9.3 [8.4, 10.2]       | +5.6 [+3.6, +8.2]       | 1.11 [0.79, 1.62]    | 0.44 [0.36, 0.50]   | trustworthy                    |
| 0.025–0.1 | relaxed into a different structure |  53 |                           0 | 33.4 [22.8, 49.7]    | 25.2 [19.2, 28.3]     | 25.2 [20.2, 30.8]     | -6.8 [-19.6, +11.6]     | 8.69 [5.99, 11.68]   | 4.37 [2.09, 9.78]   | use with caution               |
| 0.025–0.1 | same structure                     | 447 |                           0 | 15.3 [13.7, 17.0]    | 10.1 [8.8, 11.4]      | 11.9 [10.8, 13.1]     | -3.5 [-5.7, -1.4]       | 1.11 [0.96, 1.29]    | 0.53 [0.47, 0.62]   | trustworthy                    |
| 0.1–0.3   | relaxed into a different structure |  94 |                           0 | 62.7 [51.8, 73.9]    | 50.4 [40.2, 59.7]     | 55.2 [44.6, 67.4]     | -54.7 [-67.0, -42.7]    | 11.60 [5.33, 22.45]  | 3.29 [2.17, 4.79]   | not trustworthy                |
| 0.1–0.3   | same structure                     | 406 |                           0 | 24.9 [21.8, 28.3]    | 12.7 [10.9, 15.1]     | 17.8 [15.5, 20.5]     | -14.1 [-18.0, -10.3]    | 1.87 [1.59, 2.16]    | 0.85 [0.70, 1.04]   | trustworthy                    |
| >0.3      | relaxed into a different structure | 154 |                           3 | 515.4 [390.8, 653.2] | 212.5 [164.8, 267.0]  | 304.1 [231.3, 416.7]  | -508.6 [-648.2, -383.4] | 20.41 [15.63, 26.29] | 10.03 [7.10, 11.98] | not trustworthy                |
| >0.3      | same structure                     | 295 |                           3 | 123.6 [99.0, 150.6]  | 39.3 [32.3, 46.4]     | 69.5 [53.2, 89.6]     | -109.1 [-137.7, -83.4]  | 5.54 [4.36, 6.79]    | 1.63 [1.25, 2.17]   | not trustworthy                |
...
|:----------|----:|----------------------------:|:-------------------|:----------------------|:----------------------|:---------------------|:-------------------------------|
| ≤0.025    | 500 |                           0 | 13.1 [11.2, 15.6]  | 7.8 [7.0, 8.7]        | 9.4 [8.6, 10.3]       | +7.8 [+5.7, +10.5]   | trustworthy                    |
| 0.025–0.1 | 500 |                           0 | 14.4 [13.0, 15.9]  | 10.0 [8.4, 10.9]      | 11.3 [10.3, 12.4]     | +0.5 [-1.5, +2.3]    | trustworthy                    |
| 0.1–0.3   | 500 |                           0 | 18.7 [16.5, 20.9]  | 10.4 [9.0, 11.6]      | 13.5 [12.0, 15.0]     | -2.3 [-5.1, +0.3]    | trustworthy                    |
| >0.3      | 452 |                           0 | 86.1 [71.0, 101.7] | 28.6 [24.3, 34.8]     | 45.8 [37.9, 55.8]     | -61.5 [-78.8, -45.8] | not trustworthy                |
...
|:----------|:-----------------|----:|-------------------:|:---------------------|:----------------------|:----------------------|:----------------------------|
| ≤0.025    | metallic         | 150 |                  0 | 12.8 [8.7, 20.0]     | 6.7 [5.7, 7.9]        | 8.1 [6.9, 9.5]        | 98%                         |
| ≤0.025    | compound         | 350 |                  0 | 13.5 [11.7, 15.8]    | 7.7 [6.6, 8.9]        | 10.0 [8.8, 11.2]      | 97%                         |
| ≤0.025    | plausible swap   | 450 |                  0 | 13.1 [11.2, 15.8]    | 7.4 [6.4, 8.2]        | 9.3 [8.4, 10.3]       | 98%                         |
| ≤0.025    | implausible swap |  50 |                  0 | 14.7 [8.5, 24.6]     | 7.1 [4.6, 10.5]       | 9.7 [6.7, 13.1]       | 96%                         |
| 0.025–0.1 | metallic         | 150 |                  0 | 17.1 [14.2, 20.0]    | 10.5 [9.1, 14.7]      | 13.5 [11.5, 15.8]     | 93%                         |
| 0.025–0.1 | compound         | 350 |                  0 | 17.3 [14.9, 20.3]    | 10.9 [9.4, 12.2]      | 13.0 [11.5, 14.5]     | 88%                         |
| 0.025–0.1 | plausible swap   | 450 |                  0 | 16.4 [14.8, 18.0]    | 10.8 [9.9, 12.3]      | 13.2 [12.0, 14.5]     | 89%                         |
| 0.025–0.1 | implausible swap |  50 |                  0 | 24.7 [13.1, 41.4]    | 10.7 [5.8, 14.6]      | 14.0 [8.7, 21.8]      | 90%                         |
| 0.1–0.3   | metallic         | 150 |                  0 | 38.8 [31.8, 46.3]    | 21.0 [17.6, 27.0]     | 30.1 [23.9, 37.9]     | 80%                         |
| 0.1–0.3   | compound         | 350 |                  0 | 29.2 [25.3, 33.1]    | 14.5 [12.1, 17.3]     | 21.0 [18.1, 24.1]     | 82%                         |
| 0.1–0.3   | plausible swap   | 450 |                  0 | 32.0 [28.2, 35.9]    | 16.5 [13.1, 19.5]     | 23.2 [20.1, 26.5]     | 80%                         |
| 0.1–0.3   | implausible swap |  50 |                  0 | 32.1 [23.6, 42.1]    | 18.9 [13.9, 27.6]     | 25.3 [18.3, 35.8]     | 88%                         |
| >0.3      | metallic         | 101 |                  1 | 186.9 [138.8, 242.2] | 68.8 [46.4, 99.8]     | 136.8 [96.9, 183.6]   | 89%                         |
| >0.3      | compound         | 348 |                  2 | 278.6 [218.1, 344.7] | 61.6 [48.0, 80.6]     | 130.1 [105.4, 162.5]  | 58%                         |
| >0.3      | plausible swap   | 399 |                  3 | 279.3 [227.7, 338.4] | 68.6 [53.0, 84.7]     | 143.2 [118.9, 173.0]  | 65%                         |
| >0.3      | implausible swap |  50 |                  0 | 87.8 [55.7, 127.3]   | 38.6 [21.7, 70.7]     | 54.1 [37.3, 87.7]     | 68%                         |
...
|:----------|:-----------------------------------|-----:|----------------------------:|:---------------------|:----------------------|:----------------------|:-----------------------|:-------------------------------|
| <0        | relaxed into a different structure |   42 |                           2 | 108.0 [72.4, 148.6]  | 51.1 [43.9, 85.7]     | 86.7 [53.6, 130.4]    | +26.5 [-18.4, +79.5]   | not trustworthy                |
| <0        | same structure                     |  567 |                           2 | 35.2 [30.2, 41.1]    | 19.0 [17.2, 20.9]     | 23.0 [20.8, 25.4]     | +5.1 [-0.6, +11.5]     | use with caution               |
| 0–0.025   | relaxed into a different structure |   21 |                           0 | 52.9 [25.3, 88.5]    | 21.2 [11.6, 45.8]     | 34.0 [17.4, 67.3]     | +9.7 [-25.8, +51.7]    | not trustworthy                |
| 0–0.025   | same structure                     |  395 |                           0 | 24.5 [21.0, 28.8]    | 14.1 [12.5, 16.4]     | 17.3 [15.6, 19.3]     | -2.1 [-6.7, +2.6]      | trustworthy                    |
| 0.025–0.1 | relaxed into a different structure |   77 |                           2 | 89.8 [61.9, 123.7]   | 43.1 [35.4, 53.2]     | 61.8 [44.9, 83.9]     | -18.5 [-57.7, +16.3]   | not trustworthy                |
| 0.025–0.1 | same structure                     | 1041 |                           2 | 38.3 [35.7, 41.0]    | 25.0 [22.8, 27.7]     | 30.6 [28.5, 32.7]     | -20.4 [-23.7, -17.0]   | use with caution               |
| 0.1–0.3   | relaxed into a different structure |  156 |                           3 | 94.6 [83.0, 106.9]   | 81.2 [68.2, 100.5]    | 84.6 [73.8, 96.1]     | -45.5 [-62.4, -27.1]   | not trustworthy                |
| 0.1–0.3   | same structure                     | 1176 |                           3 | 61.9 [58.3, 65.7]    | 46.0 [43.2, 48.7]     | 52.6 [49.6, 55.9]     | -41.4 [-45.8, -37.1]   | not trustworthy                |
| >0.3      | relaxed into a different structure |   92 |                           0 | 199.1 [161.5, 240.5] | 141.8 [108.4, 188.0]  | 165.5 [135.1, 202.8]  | -137.9 [-186.6, -89.1] | not trustworthy                |
| >0.3      | same structure                     |  426 |                           0 | 108.1 [98.2, 118.4]  | 72.8 [67.0, 83.1]     | 89.5 [81.3, 98.7]     | -78.2 [-90.9, -65.7]   | not trustworthy                |

Single point at WBM's DFT-relaxed structure:

| bin       |    n |   excluded (guard, per bin) | energy MAE         | energy median |err|   | energy trimmed mean   | mean signed          | energy verdict (pessimistic)   |
|:----------|-----:|----------------------------:|:-------------------|:----------------------|:----------------------|:---------------------|:-------------------------------|
| <0        |  609 |                           2 | 40.7 [34.5, 47.5]  | 19.2 [17.1, 21.7]     | 23.8 [21.7, 26.1]     | +17.1 [+10.2, +24.4] | use with caution               |
| 0–0.025   |  416 |                           0 | 25.2 [21.7, 29.6]  | 13.6 [12.9, 16.2]     | 17.7 [15.9, 19.7]     | +4.4 [-0.0, +9.2]    | trustworthy                    |
| 0.025–0.1 | 1118 |                           2 | 37.5 [34.6, 40.6]  | 23.1 [20.9, 25.0]     | 28.6 [26.8, 30.5]     | -10.1 [-13.8, -6.5]  | use with caution               |
| 0.1–0.3   | 1332 |                           3 | 55.4 [52.4, 58.4]  | 41.5 [38.3, 44.4]     | 46.4 [44.1, 49.0]     | -26.7 [-30.6, -22.5] | use with caution               |
| >0.3      |  518 |                           0 | 95.8 [87.7, 104.2] | 67.6 [59.5, 75.8]     | 78.9 [72.5, 86.0]     | -47.8 [-59.1, -36.8] | not trustworthy                |
...
Share of stable materials in the calibration set: 0.153 (n=3,993).

| threshold                          |   called stable | precision         | recall            | F1                | NPV                  | DAF               | precision verdict (lower bound)   |
|:-----------------------------------|----------------:|:------------------|:------------------|:------------------|:---------------------|:------------------|:----------------------------------|
| +0 meV/atom (on-hull)              |             869 | 0.55 [0.52, 0.58] | 0.78 [0.75, 0.82] | 0.65 [0.62, 0.67] | 0.958 [0.951, 0.965] | 3.61 [3.41, 3.82] | not trustworthy                   |
| -30 meV/atom (cost-optimal)        |             474 | 0.69 [0.64, 0.73] | 0.53 [0.49, 0.57] | 0.60 [0.56, 0.63] | 0.919 [0.910, 0.928] | 4.50 [4.20, 4.84] | use with caution                  |
| −50 meV/atom (round-1 exploration) |             339 | 0.70 [0.65, 0.75] | 0.39 [0.35, 0.43] | 0.50 [0.46, 0.54] | 0.898 [0.888, 0.908] | 4.60 [4.25, 5.00] | use with caution                  |
...
|----------------------------------:|-------------------------------:|------------:|---------:|------------------------------:|
|                             0.250 |                       -150.000 |       0.803 |    0.080 |                         0.038 |
|                             0.500 |                        -40.000 |       0.706 |    0.461 |                         0.070 |
|                             1.000 |                        -30.000 |       0.686 |    0.534 |                         0.108 |
|                             2.000 |                        -10.000 |       0.610 |    0.701 |                         0.160 |
|                             4.000 |                         10.000 |       0.495 |    0.854 |                         0.222 |
...
|------------:|----------------:|-----:|-----:|-----:|------------:|---------:|------:|------:|------:|
|      -0.150 |              61 |   49 |   12 |  560 |       0.803 |    0.080 | 0.146 | 0.858 | 5.267 |
|      -0.100 |             140 |  101 |   39 |  508 |       0.721 |    0.166 | 0.270 | 0.868 | 4.730 |
|      -0.050 |             339 |  238 |  101 |  371 |       0.702 |    0.391 | 0.502 | 0.898 | 4.603 |
|       0.000 |             869 |  478 |  391 |  131 |       0.550 |    0.785 | 0.647 | 0.958 | 3.607 |
|       0.050 |            1825 |  580 | 1245 |   29 |       0.318 |    0.952 | 0.477 | 0.987 | 2.084 |
|       0.100 |            2489 |  588 | 1901 |   21 |       0.236 |    0.966 | 0.380 | 0.986 | 1.549 |
|       0.150 |            2946 |  591 | 2355 |   18 |       0.201 |    0.970 | 0.332 | 0.983 | 1.315 |
...
| 0.1–0.3    | 1332 | 0.02 [0.01, 0.02] | false-positive rate |
...
Same model checkpoint (`2023-12-03-mace-128-L1_epoch-199`), same hull-distance construction, threshold 0. Published: Matbench Discovery, models/mace/mace-mp-0.yml (unique-prototype subset); their relaxation: FIRE, fmax 0.05 eV/Å, ≤ 500 steps, FrechetCellFilter. Ours: BFGS + FrechetCellFilter, fmax 0.01 eV/Å **and** |stress| ≤ 0.01 GPa, fallback ladder on failure.

| metric         |   Matbench Discovery (published) |   this harness (calibration set) | 95 % CI              | published value inside CI   |
|:---------------|---------------------------------:|---------------------------------:|:---------------------|:----------------------------|
| F1             |                            0.669 |                            0.647 | 0.647 [0.618, 0.674] | yes                         |
| DAF            |                            3.777 |                            3.607 | 3.607 [3.414, 3.816] | yes                         |
| precision      |                            0.577 |                            0.550 | 0.550 [0.517, 0.581] | yes                         |
| recall         |                            0.796 |                            0.785 | 0.785 [0.751, 0.816] | yes                         |
| accuracy       |                            0.878 |                            0.869 | 0.869 [0.859, 0.879] | yes                         |
| MAE (eV/atom)  |                            0.057 |                            0.059 | 0.059 [0.056, 0.061] | yes                         |
| RMSE (eV/atom) |                            0.101 |                            0.099 |                      |                             |
| R2             |                            0.697 |                            0.690 |                      |                             |
...
|:------------------|----------:|:--------------------|:------------------|:-------------------|------------------:|:--------------------|:-------------------|:--------------------|--------------------------:|:---------------------------------|
| <0                |        58 | 40.1 [26.3, 56.4]   | 20.3 [14.4, 26.6] | 26.8 [18.8, 41.4]  |                55 | 39.6 [26.4, 56.4]   | 18.9 [13.4, 24.6]  | 26.5 [18.9, 41.3]   |                         3 | use with caution                 |
| 0–0.025           |        57 | 26.8 [18.2, 36.5]   | 13.8 [9.7, 21.9]  | 19.7 [13.7, 27.9]  |                54 | 29.5 [19.5, 42.5]   | 15.4 [7.8, 24.6]   | 21.3 [14.7, 29.9]   |                         3 | use with caution                 |
| 0.025–0.1         |        61 | 39.8 [28.0, 52.9]   | 22.5 [14.0, 30.7] | 29.5 [20.9, 39.7]  |                55 | 44.0 [32.4, 57.7]   | 27.5 [17.4, 44.8]  | 35.8 [26.0, 47.3]   |                         5 | use with caution                 |
| 0.1–0.3           |        62 | 68.5 [52.5, 86.0]   | 48.1 [38.3, 69.4] | 56.1 [43.3, 73.8]  |                54 | 76.7 [58.1, 98.4]   | 60.3 [41.5, 83.8]  | 63.8 [50.1, 82.9]   |                         8 | not trustworthy                  |
| >0.3              |        59 | 106.3 [81.5, 134.1] | 79.4 [57.5, 98.1] | 90.6 [66.1, 118.2] |                48 | 124.6 [94.0, 159.0] | 90.2 [47.3, 134.6] | 109.2 [77.7, 147.4] |                        11 | not trustworthy                  |
...
|:--------------|---------:|--------------------:|--------------------:|-----------------:|-------------------------:|
| chalcogenide  |  260.000 |               0.908 |               0.877 |            0.785 |                    0.150 |
| f-electron    | 2032.000 |               0.901 |               0.902 |            0.803 |                    0.159 |
| halide        |  195.000 |               0.908 |               0.908 |            0.815 |                    0.202 |
| intermetallic |  733.000 |               0.907 |               0.903 |            0.810 |                    0.149 |
| other         |  299.000 |               0.910 |               0.893 |            0.803 |                    0.172 |
| oxide         |  235.000 |               0.898 |               0.906 |            0.804 |                    0.127 |
| pnictide      |  239.000 |               0.908 |               0.908 |            0.816 |                    0.182 |
| all           | 3993.000 |               0.904 |               0.901 |            0.804 |                    0.160 |

**Why the labels do not come from these bounds.** Routing on them was tried first: the bounds hold ~90 % of the time per group, yet only 74% of the candidates whose upper bound fell below 0 were truly stable — marginal coverage does not control the error rate among the candidates a rule selects. The labels therefore use per-family thresholds certified directly on that quantity (Learn-then-Test style): the loosest threshold whose 'stable' calls have precision ≥ 90%, and the most inclusive whose 'unstable' calls have NPV ≥ 95%, each with a one-sided Clopper–Pearson bound at 95% confidence, Bonferroni-corrected over the 61-point threshold grid. Families with fewer than 100 labelable calibration structures get no label (DFT).
...
|:----------------------------------------------|:------------------------------|------------------------------:|
| n                                             | 3993                          |                      3993.000 |
| likely stable                                 | 0                             |                        39.000 |
| likely unstable                               | 1455                          |                      1943.000 |
| send to DFT                                   | 2538                          |                      2011.000 |
| precision of 'likely stable'                  | undefined                     |                         0.744 |
| NPV of 'likely unstable'                      | 0.980                         |                         0.985 |
| share sent to DFT                             | 0.636                         |                         0.504 |
| truly stable found as 'likely stable'         | 0.000                         |                         0.048 |
| truly stable sent to DFT                      | 0.952                         |                         0.903 |
| truly stable wrongly called 'likely unstable' | 0.048                         |                         0.049 |
...
Why candidates were sent to DFT (a candidate can have several reasons): low confidence: between the certified thresholds: 1932, known-weak chemistry: 653, relaxation changed the structure: 422, low confidence: no certified thresholds for family 'halide': 74.
...
| f-electron    | <0              | 520 | stable   | 0.56 [0.52, 0.60] |
...
**Routing: no stable label certified at this confidence.** The per-family thresholds certified at 95% confidence for precision ≥ 90% admit no candidate, so 'likely stable' is never awarded and its precision is undefined — not zero, and not a number to be compared. Every candidate is routed to 'likely unstable' (1,455) or to DFT (2,538). scorecard.json omits `routing_precision of 'likely stable'` rather than emitting NaN.
...
|:----------|----:|:---------------------|:-----------------------|:------------------------|
| Pu        |  99 | 221.5 [184.4, 260.6] | +110.3 [+56.7, +165.3] | not trustworthy         |
...
| Mn        | 241 | 66.4 [55.8, 77.9]    | -34.2 [-47.5, -20.7]   | not trustworthy         |
...
| Zn        | 220 | 48.2 [40.9, 56.4]    | -31.0 [-40.1, -22.1]   | use with caution        |
...
|:----------|:--------------------|----:|----------------------------:|:---------------------|:----------------------|:----------------------|:------------------------|:-------------------------------|
| ≤0.025    | magnetic in PBE     | 156 |                           0 | 17.8 [13.0, 25.0]    | 8.4 [6.7, 11.4]       | 11.5 [9.5, 13.9]      | +10.9 [+5.4, +18.4]     | trustworthy                    |
| ≤0.025    | non-magnetic in PBE | 334 |                           0 | 10.3 [9.1, 11.6]     | 6.9 [5.9, 7.9]        | 8.4 [7.5, 9.4]        | +3.2 [+1.6, +4.8]       | trustworthy                    |
| 0.025–0.1 | magnetic in PBE     | 219 |                           0 | 15.5 [13.2, 17.8]    | 10.6 [9.1, 12.2]      | 12.1 [10.6, 13.9]     | +1.6 [-1.3, +4.7]       | trustworthy                    |
| 0.025–0.1 | non-magnetic in PBE | 242 |                           0 | 15.0 [12.9, 17.3]    | 9.0 [7.5, 10.7]       | 11.8 [10.2, 13.6]     | -7.7 [-10.5, -5.1]      | trustworthy                    |
| 0.1–0.3   | magnetic in PBE     | 235 |                           0 | 23.6 [19.7, 27.3]    | 12.1 [10.4, 15.1]     | 17.3 [14.4, 20.6]     | -11.0 [-15.6, -6.6]     | trustworthy                    |
| 0.1–0.3   | non-magnetic in PBE | 190 |                           0 | 24.3 [19.9, 29.1]    | 12.7 [8.3, 17.3]      | 17.1 [14.0, 20.8]     | -15.4 [-20.6, -10.1]    | trustworthy                    |
| >0.3      | magnetic in PBE     | 171 |                           2 | 157.3 [124.5, 194.2] | 57.1 [40.1, 68.8]     | 110.4 [82.1, 141.8]   | -143.8 [-182.4, -109.2] | not trustworthy                |
| >0.3      | non-magnetic in PBE | 144 |                           2 | 74.8 [49.5, 103.3]   | 21.7 [18.0, 32.3]     | 37.4 [29.8, 51.0]     | -59.2 [-88.1, -32.4]    | not trustworthy                |
...
| Ta6OsPb2 (wbm-5-21439)      | new (WBM)  |         0.887 |       -618.591 | far above the hull (> 0.3 eV/atom): a hypothetical structure that need not be a minimum for the model; new composition/prototype (not in MPtrj)                                                                              |
...
|:------------------------------------------------|:-----------|----:|-------------------:|---------------------:|--------------------:|-------------------------:|----------------------------:|--------------------:|--------------------:|
| room temperature (Lucero 2012)                  | non-metals |  33 |                  0 |                 1.16 |                1.16 |                     1.10 |                        1.14 |                1.23 |               -0.07 |
| 0 K extrapolated (Lucero 2012)                  | non-metals |   6 |                  0 |                 0.96 |                0.96 |                     0.80 |                        0.96 |                1.04 |               -0.07 |
| 0 K, zero-point expansion removed (Csonka 2009) | metals     |  14 |                  0 |                 0.91 |                1.20 |                     1.00 |                        1.17 |                0.83 |                0.08 |
| 0 K, zero-point expansion removed (Csonka 2009) | non-metals |  10 |                  0 |                 1.76 |                1.76 |                     1.75 |                        1.70 |                1.84 |               -0.08 |
...
Birch–Murnaghan fits vs MP elastic K_VRH: MAE 8.6 [6.0, 12.0] % (n=82), median |err| 4.7 [3.8, 7.0] %, 10% trimmed mean 6.3 [5.0, 7.8] %; verdict use with caution (from the MAE's pessimistic bound). Not stratified by hull distance: every material is on or near the hull. EOS points rejected by the convergence / sanity / energy guard never enter a fit; a fit needs at least 7 usable points.

Exclusions, stated in full: 0 of 83 fits excluded for fit quality (RMS > 1.0 meV/atom or V0 outside the sampled range); 1 excluded for an impossible MP REFERENCE (K_VRH outside (0, 600] GPa — above diamond's ~443 GPa): K (mp-aaaaaacg): K_VRH 33,306 GPa next to K_Reuss 3.7 GPa. Keeping it the MAE is 9.7 [6.5, 13.8] % over n=83; that number measures MP's Voigt average, not this engine, which is why the verdict does not use it.
...
| substitution_auto |        15808 |      4.1 |  30.5 |      64.5 |
