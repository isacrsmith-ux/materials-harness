...
Opened once (2026-09-12T03:33:29+00:00); every rule fitted on the calibration set only. 3,999 usable test relaxations, 1 rejected by the guard (counted). Disagreement tolerance 165 meV/atom (95th percentile on calibration).
...
| likely unstable                               | 2146.000 |
| send to DFT                                   | 1629.000 |
...
| bin       |    n | energy MAE         | median |err|      | trimmed mean      |
|:----------|-----:|:-------------------|:------------------|:------------------|
| <0        |  611 | 15.3 [13.0, 18.5]  | 8.1 [7.1, 9.2]    | 10.2 [9.2, 11.3]  |
| 0–0.025   |  416 | 11.0 [9.7, 12.5]   | 6.7 [5.9, 7.6]    | 8.1 [7.2, 9.1]    |
| 0.025–0.1 | 1120 | 14.1 [13.3, 15.1]  | 9.3 [8.6, 10.1]   | 11.3 [10.6, 12.1] |
| 0.1–0.3   | 1334 | 30.2 [27.6, 32.9]  | 16.4 [15.6, 17.7] | 20.0 [18.7, 21.3] |
| >0.3      |  518 | 86.7 [73.0, 103.1] | 32.9 [27.9, 37.9] | 51.5 [43.8, 60.4] |
